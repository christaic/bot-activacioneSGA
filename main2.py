...
ENCABEZADOS = [
    ...
    "FECHA FINALIZADO", "CTO ANTIGUA", "OLT ANTIGUA", "OLT NUEVO", 
...
CAMPOS_PLANTILLA = {
    ...
    "CAMBIO_CTO_SPLITTER": ["TICKET", "CODIGO CLIENTE", "CLIENTE", "DNI ó CE", "DIRECCION", "CTO", "PUERTO UTILIZADO", "PARTNER", "CUADRILLA", "DISTRITO", "OBSERVACIÓN"]
}
...
FLUJOS = {
    ...
    "CAMBIO_CTO_SPLITTER": ["PLANTILLA", "SN_ACTUAL", "PHONOWIN", "FOTO_CTO", "FOTO_PUERTO", "FOTO_ONT_ACTUAL", "FOTO_POTENCIA"] # 🔥 NUEVO (Copia exacta de CAMBIO_CTO)
}
...
NOMBRES_OPERACIONES = {
    ...
    "CAMBIO_CTO_SPLITTER": "5️⃣ CAMBIO DE CTO  POR RETIRO DE SPLITTER" # 🔥 NUEVO
}
